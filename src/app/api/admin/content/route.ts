...
// POST isteği için Zod şeması. Hem tekli hem de toplu güncellemeleri destekler.
...
export async function DELETE(request: NextRequest) {
    ...
    try {
        ...
        for (const imageUrl of [...new Set(imageUrls)]) {
            ...
            if (!imagePath.startsWith(publicDir)) continue;
            try {
 ...
 * Hem tekli (nesne) hem de toplu (dizi) istekleri kabul eder.
 */
