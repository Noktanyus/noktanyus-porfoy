...
const CHANNELS = [
  {
    ...
    description:
      'Template, script ve dijital paketler. Bir kez satın al, indir, hemen kullan.',
    points: ['Hazır template & starter', 'Script ve araçlar', 'Anında indirme + lisans'],
    icon: FaBoxOpen,
  ...
  },
  {
    ...
    eyebrow: 'Abonelik',
    description:
      'API, izleme ve destek — hesabınla kullan. Bireysel, Profesyonel veya Destek+ seç.',
    points: ['Kolay başlangıç', 'API key & kota', 'İstediğin zaman iptal'],
