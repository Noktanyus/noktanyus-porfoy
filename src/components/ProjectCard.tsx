...
const ProjectCard = ({ project }: ProjectCardProps) => {
  // Ana görselin URL'si. Eğer belirtilmemişse, varsayılan bir görsel kullanılır.
    ...
    <div className="project-card bg-light-bg dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-lg p-4 grid md:grid-cols-3 gap-6 items-center shadow-card-light dark:shadow-card-dark hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="md:col-span-2 flex flex-col h-full">
        ...
        <div className="flex flex-wrap gap-3 mt-auto">
          ...
          {project.liveDemo && (
            <a href={project.liveDemo} target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-green-600 text-white font-bold py-2 px-3 rounded-lg hover:bg-green-700 transition-colors text-sm">
              <FaExternalLinkAlt className="mr-2" />
              Canlı Demo
            </a>
          )}
          {project.githubRepo && (
            <a href={project.githubRepo} target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-gray-700 text-white font-bold py-2 px-3 rounded-lg hover:bg-gray-800 transition-colors text-sm">
