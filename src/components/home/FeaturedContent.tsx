  ...
  return (
    <div className="relative flex items-center justify-center min-h-[250px]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-10 w-20 h-20 bg-blue-200/20 dark:bg-blue-800/10 rounded-full"></div>
        <div className="absolute bottom-16 right-8 w-16 h-16 bg-purple-200/20 dark:bg-purple-800/10 rounded-full"></div>
        <div className="absolute top-1/2 left-4 w-12 h-12 bg-green-200/20 dark:bg-green-800/10 rounded-full"></div>
      </div>
      ...
      {homeSettings.featuredContentType === "text" && homeSettings.textTitle && (
        <div className="w-full max-w-lg p-8 bg-white dark:bg-dark-card rounded-xl shadow-2xl border border-gray-200 dark:border-dark-border relative z-10">
