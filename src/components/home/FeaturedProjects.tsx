    ...
    return (
      <section className="py-12">
        <div className="container-responsive text-center">
          <h2 className="text-3xl font-bold mb-4 text-muted-foreground">Öne Çıkan Projeler</h2>
          <p className="text-muted-foreground">Henüz öne çıkan proje yok. Yakında eklenecek.</p>
        </div>
      </section>
    );
  }
