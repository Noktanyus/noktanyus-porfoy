  ...
  return (
    <div className={cn("text-center md:text-left")}>
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
        {/* Profile Image */}
        <div className="relative w-36 h-36 sm:w-40 sm:h-40 md:w-48 md:h-48 flex-shrink-0 animate-scale-in">
          <OptimizedImage
        ...
        <div className="flex-grow space-y-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-white bg-gradient-to-r from-gray-900 to-blue-600 dark:from-gray-100 dark:to-blue-400 bg-clip-text text-transparent animate-fade-in">
            {aboutData.name}
          </h1>
          
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-400 animate-fade-in" style={{animationDelay: '0.2s'}}>
            {aboutData.title}
          </p>
          
          {/* Social Icons */}
          <div className="flex justify-center md:justify-start gap-4 pt-2 animate-fade-in" style={{animationDelay: '0.3s'}}>
            <a
